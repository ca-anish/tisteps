...
class UserDataService {
  ...
  Future <List<UserDetailsModel>> getLoadMoreUserList(int page) async {
    try {
      Response apiResponse = await ApiClient.instance.dio
          .get(EndPoints.getUsers, queryParameters: {"page": page});
      BasicResponse basicResponse = BasicResponse.fromJson(apiResponse.data);
      Iterable<UserDetailsModel> profileList =
      (basicResponse.data as List<dynamic>)
          .map((doc) => UserDetailsModel.fromJson(doc));
